window["FHIR"] = /******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = "./src/browser.js")
  );
  /******/
})(
  /************************************************************************/
...
*/
  ...
  \*******************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function (process) {
          ...
          __webpack_require__(
            /*! core-js/modules/es.regexp.constructor */ "./node_modules/core-js/modules/es.regexp.constructor.js"
          );
  ...
  \***********************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        __webpack_require__(
          /*! core-js/modules/es.array.flat */ "./node_modules/core-js/modules/es.array.flat.js"
        );
        ...
        __webpack_require__(
          /*! core-js/modules/es.array.unscopables.flat */ "./node_modules/core-js/modules/es.array.unscopables.flat.js"
        );
        ...
        __webpack_require__(
          /*! core-js/modules/web.url */ "./node_modules/core-js/modules/web.url.js"
        );
                            ...
                            return _regenerator.default.wrap(function _callee7$(
                              ...
                              while (1) {
                                switch ((_context7.prev = _context7.next)) {
                                  case 0:
                                    resourceType = url.pathname
                                      .split("/")
                                      .pop();

                                    if (
                                      !(
                                        patientCompartment.indexOf(
                                          resourceType
                                        ) == -1
                                      )
                                    ) {
        ...
        function getRef(refId, cache, client) {
          ...
          if (!sub) {
            ...
            cache[refId] = client.request(refId).then(
              function (sub) {
                cache[refId] = sub;
                return sub;
              },
        ...
        function resolveRef(obj, path, graph, cache, client) {
          ...
          if (node) {
            ...
            return Promise.all(
              makeArray(node).map(function (item, i) {
                var ref = item.reference;

                if (ref) {
                  return getRef(ref, cache, client)
                    .then(function (sub) {
                      if (graph) {
                        if (isArray) {
        ...
        function resolveRefs(obj, fhirOptions, cache, client) {
          ...
          var paths = makeArray(fhirOptions.resolveReferences)
          ...
          (function () {
                ...
                request: function request(requestOptions, fhirOptions) {
                  ...
                  if (_this.patient.id) {
                            ...
                            switch ((_context.prev = _context.next)) {
                              ...
                              case 2:
                                ...
                                return _context.abrupt(
                                  "return",
                                  _this.request(options, fhirOptions)
                                );
                    ...
                    return Promise.reject(
                      new Error("Patient is not available")
                    );
                  }
                },
              }; // encounter api -------------------------------------------------------
                          ...
                          switch ((_context6.prev = _context6.next)) {
                            ...
                            case 5:
                              ...
                              return _context6.abrupt(
                                "return",
                                _request(url, requestOptions) // Automatic re-auth via refresh token -----------------------------
                                  .catch(function (error) {
                                    debug("%o", error);

                                    if (
                                      error.status == 401 &&
                                      fhirOptions.useRefreshToken !== false
                                    ) {
                                      var hasRefreshToken = _getPath(
                                        _this2,
                                  ...
                                  .then(function (data) {
                                    ...
                                    if (
                                      ...
                                      return data; // Resolve References ----------------------------------------------
            ...
            _proto.refresh = function refresh() {
              ...
              if (scopes.indexOf("offline_access") == -1) {
                throw new Error(
                  "Unable to refresh. No offline_access scope found."
                );
              ...
              if (!this._refreshTask) {
                this._refreshTask = _request(tokenUri, {
                  ...
                  .finally(function () {
                    ...
                    _this3.environment
                      .getStorage()
                      .set(_this3.state.key, _this3.state);
                  });
              }
  ...
  \**************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        __webpack_require__(
          /*! core-js/modules/web.url.to-json */ "./node_modules/core-js/modules/web.url.to-json.js"
        );
  ...
  \****************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* global fhir */
        var BrowserStorage = __webpack_require__(
          /*! ../storage/BrowserStorage */ "./src/storage/BrowserStorage.js"
        );

        var BaseAdapter = __webpack_require__(
          /*! ./BaseAdapter */ "./src/adapters/BaseAdapter.js"
        );
        /**
         * Browser Adapter
         * @type {fhirclient.Adapter}
  ...
  \************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var smart = __webpack_require__(
          /*! ./adapters/BrowserAdapter */ "./src/adapters/BrowserAdapter.js"
        );
  ...
  \********************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function (global) {
           ...
           */
          var HttpError = __webpack_require__(
            /*! ./HttpError */ "./src/HttpError.js"
          );
          ...
          function ensureNumerical(_ref2) {
            ...
            if (typeof value !== "number") {
              throw new Error(
                "Found a non-numerical unit: " + value + " " + code
              );
            }
          }
          ...
          function getPatientParam(conformance, resourceType) {
            ...
            if (!Array.isArray(meta.searchParam))
              throw new Error(
                'No search parameters supported for "' +
                  resourceType +
                  '" on this FHIR server'
            ...
            if (!out)
              throw new Error(
                "I don't know what param to use for " + resourceType
              );
            return out;
          }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function fetchConformanceStatement(baseUrl) {
          ...
          return getAndCache(url).catch(function (ex) {
            throw new Error(
              'Failed to fetch the conformance statement from "' +
                url +
                '". ' +
                ex
            );
        ...
        function getSecurityExtensions(baseUrl) {
          ...
          return fetchWellKnownJson(baseUrl)
            .then(function (meta) {
            ...
            .catch(function () {
              return fetchConformanceStatement(baseUrl).then(function (
                metadata
              ) {
                var nsUri =
                  "http://fhir-registry.smarthealthit.org/StructureDefinition/oauth-uris";
                var extensions = (
                  getPath(metadata || {}, "rest.0.security.extension") || []
                )
                  .filter(function (e) {
                    return e.url === nsUri;
                  })
                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      fhirServiceUrl =
                        url.searchParams.get("fhirServiceUrl") ||
                        fhirServiceUrl;
                    ...
                    case 18:
                      ...
                      redirectUrl =
                        redirectUri + "?state=" + encodeURIComponent(stateKey); // bypass oauth if fhirServiceUrl is used (but iss takes precedence)
                    ...
                    case 45:
                      ...
                      redirectUrl =
                        state.authorizeUri + "?" + redirectParams.join("&");
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 11:
                      ...
                      msg = [authError, authErrorDescription]
                        .filter(Boolean)
                        .join(": ");
                      throw new Error(msg);
                    ...
                    case 19:
                      ...
                      fullSessionStorageSupport = isBrowser()
                        ...
                        : true; // Do we have to remove the `code` and `state` params from the URL?
                      ...
                      throw new Error(
                        "No state found! Please (re)launch the app."
                      );
                    ...
                    case 25:
                      ...
                      debug(
                        "Preparing to exchange the code for access token..."
                      );
                      _context2.next = 30;
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    ...
                    case 14:
                      ...
                      return _context4.abrupt(
                        "return",
                        Promise.resolve(createClient(env, cached))
                      );

                    case 17:
                      return _context4.abrupt(
                        "return",
                        authorize(env, options).then(function () {
